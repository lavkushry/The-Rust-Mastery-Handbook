...
## 2024-05-26 - Screen Reader Announcements of Unicode Arrows
**Learning:** Unicode arrows (like `←` and `→`) within text content are read literally by screen readers (e.g., 'Leftwards arrow Prev', 'Next Rightwards arrow').
