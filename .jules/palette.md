...
## 2024-07-19 - Run Playground Links
**Learning:** Custom overlay links like 'Run in Rust Playground' lack descriptive context and default focus rings.
**Action:** Add descriptive `aria-label` explaining action and destination (new tab), and ensure explicit `:focus-visible` styles are added.
