...
## 2024-05-26 - Unicode Characters in Interactive Elements
**Learning:** Unicode arrows (like `↗`, `←`, and `→`) and checkmarks (like `✓`) within text content are read literally by screen readers (e.g., 'North East Arrow' or 'Check mark').
