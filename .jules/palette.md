...
## 2025-02-12 - Announcing Dynamic Counter Updates
**Learning:** When building custom interactive components like step indicators or flashcard progress trackers, screen readers will not naturally announce text content updates if they happen without focus changes.
**Action:** Always wrap dynamic counter text in `aria-live="polite"` and `aria-atomic="true"` regions to ensure users are natively alerted.
