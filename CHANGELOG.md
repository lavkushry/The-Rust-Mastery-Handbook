...
- CI workflow for mdBook build verification.

### Changed

- README upgraded to an OSS-grade project homepage with quick start, architecture, and contribution pathways.
- book.toml metadata improved with repository and edit-link settings.
